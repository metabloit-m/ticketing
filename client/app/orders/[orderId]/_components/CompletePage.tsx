...
import { Check, CircleCheck, CircleX, Info } from 'lucide-react';
  ...
  return (
    <div id='payment-status'>
      <div className={'flex space-x-2'}>
        <p id='status-text'>{STATUS_CONTENT_MAP[status].text}</p>
        <span id='status-icon'>{STATUS_CONTENT_MAP[status].icon}</span>
      </div>
      {!intentId && (
